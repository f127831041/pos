 ...
 */
@Entity
@Table(name = "returned_history")
@Data
public class ReturnedHistory extends BaseEntity {
     ...
     * 轉出庫存狀態 1:是 2:否
     */
    @Column(name = "status", length = 1, columnDefinition = "varchar(1) DEFAULT '2' COMMENT '轉出庫存狀態 1:是 2:否'")
    ...
    @Column(name = "returned_date", columnDefinition = "date COMMENT '退貨日期'")
